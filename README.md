...
**[Live demo](https://evangenieur.github.io/barometr/)**
...
The project deploys automatically to GitHub Pages on push to `master` via the included workflow (`.github/workflows/deploy.yml`).

To deploy manually:

```bash
NEXT_PUBLIC_BASE_PATH=/barometr npm run build
